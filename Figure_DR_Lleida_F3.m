...
l1A=legend('PCR','EMR','Location','northwest');
l1A.Position(1:2) = [0.62-mx-DX 0.82];
...
l2A.Position(1:3) = [0.72-mx-DX,0.82+l1A.Position(4)-l2A.Position(4) 0.1336];
l2A.LineWidth = 1.5;
...
l2A.Position(1:3) = [0.72,0.82+l1A.Position(4)-l2A.Position(4) 0.1336];
l2A.LineWidth = 1.5;


print(f,'./Figures&Tables/Figure_DR_Lleida_F3.png','-dpng','-r600')
